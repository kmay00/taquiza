...
class DishesControllerTest < ActionController::TestCase
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post :create, dish: { description: @dish.description, name: @dish.name, price: @dish.price, vegetarian: @dish.vegetarian }
    end
  ...
  test "should update dish" do
    patch :update, id: @dish, dish: { description: @dish.description, name: @dish.name, price: @dish.price, vegetarian: @dish.vegetarian }
    assert_redirected_to dish_path(assigns(:dish))
  end
